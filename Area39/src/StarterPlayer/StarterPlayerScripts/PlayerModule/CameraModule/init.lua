...
function CameraModule:Update(dt)
	...
	if not con then
		con = script.toggleMouseLock.Event:Connect(function(enabled,offset)
			if self.activeCameraController then
				self.activeCameraController:SetIsMouseLocked(enabled)
				self.activeCameraController:SetMouseLockOffset(offset)
			end
		end)
	end
end
