...
local StatePosition = {
	...
	[Enumeration.SnackbarPosition.Center.Value] = {
		...
		ExitPosition = UDim2.new(0.5, 0, 0, (-36*3));
		EnterPosition = UDim2.new(0.5, 0, 0, -HEIGHT - CORNER_OFFSET + 36);
	};
}
...
return PseudoInstance:Register("Snackbar", {
	...
	Init = function(self, ...)
		...
		SnackbarAction.PrimaryColor3 = Color3.new(26/255,121/255,234/255)
