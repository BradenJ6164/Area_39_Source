...
local Icon = require(script.Parent.CoreIcon)
local topbarIcons = {}
...
function IconController:createIcon(name, imageId, order)
	...
	icon.selected:Connect(function()
		...
		for _, otherIcon in pairs(allIcons) do
			if icon.deselectWhenOtherIconSelected and otherIcon ~= icon and otherIcon.deselectWhenOtherIconSelected and otherIcon.toggleStatus == "selected" and otherIcon.name ~= "Toggle Ambience"and otherIcon.name ~= "Radio" then
				otherIcon:deselect()
			end
		end
	end)
